...
def main(args):
    ...
    for img_fp in args.files:
        ...
        for rect in rects:
            ...
            if args.dump_obj:
                wfp = '{}_{}_rada.obj'.format(img_fp.replace(suffix, ''), ind)
        ...
        if args.dump_pncc:
            ...
            print('Dump to {}'.format(wfp))
        if args.dump_res:
            draw_landmarks(img_ori, pts_res, wfp=img_fp.replace(suffix, '_rada.jpg'), show_flg=args.show_flg)
